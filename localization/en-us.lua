    ...
    descriptions = {
        Joker = {
            j_MDJ_ZZaZZ = {
                ...
                text = {
                    "{f:MDJ_pokemon}Convert {C:chips,f:MDJ_pokemon}Chips{f:MDJ_pokemon} To Base {C:attention,E:1,f:MDJ_pokemon}((MULT-1)%#1#)+1",
                    "{f:MDJ_pokemon}Convert {C:mult,f:MDJ_pokemon}Mult{f:MDJ_pokemon} To Base {C:attention,E:1,f:MDJ_pokemon}((CHIPS-1)%#1#)+1",
                    "{f:MDJ_pokemon}Convert {C:chips,f:MDJ_pokemon}Chips{f:MDJ_pokemon} To Base {C:attention,E:1,f:MDJ_pokemon}((MULT-1)%#1#)+1",
                    "{f:MDJ_pokemon}Convert {C:mult,f:MDJ_pokemon}Mult{f:MDJ_pokemon} To Base {C:attention,E:1,f:MDJ_pokemon}((CHIPS-1)%#1#)+1",
                    "{f:MDJ_pokemon}ZZnZZrZZ{C:chips,f:MDJ_pokemon}CZZpZ{f:MDJ_pokemon}ZTZZBZZeZ{C:attention,E:1,f:MDJ_pokemon}Z(ZZLZZ1ZZ2ZZ)+1",
                    "{f:MDJ_pokemon}ZZnZZrZZ{C:mult,f:MDJ_pokemon}MZZt{f:MDJ_pokemon}ZZoZZaZZ {C:attention,E:1,f:MDJ_pokemon}ZZCZZPZZ1ZZ2ZZ)+1",
                    "{f:MDJ_pokemon}ZZnZZrZZ{C:chips,f:MDJ_pokemon}CZZpZ{f:MDJ_pokemon}ZTZZBZZeZ{C:attention,E:1,f:MDJ_pokemon}Z(ZZLZZ1ZZ2ZZ)+1",
                    "{f:MDJ_pokemon}ZZnZZrZZ{C:mult,f:MDJ_pokemon}MZZt{f:MDJ_pokemon}ZZoZZaZZ {C:attention,E:1,f:MDJ_pokemon}ZZCZZPZZ1ZZ2ZZ)+1",
                    "{f:MDJ_pokemon}ZZnZZrZZ{C:chips,f:MDJ_pokemon}CZZpZ{f:MDJ_pokemon}ZTZZBZZeZ{C:attention,E:1,f:MDJ_pokemon}Z(ZZLZZ1ZZ2ZZ)+1",
                    "{f:MDJ_pokemon}ZZnZZrZZ{C:mult,f:MDJ_pokemon}MZZt{f:MDJ_pokemon}ZZoZZaZZ {C:attention,E:1,f:MDJ_pokemon}ZZCZZPZZ1ZZ2ZZ)+1",
            ...
            j_MDJ_net = {
                name = 'Safety Net',
                text = {
                    "Earn a {C:attention}quarter{} of the previous payout",
